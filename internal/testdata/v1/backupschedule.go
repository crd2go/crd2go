...
type Policies struct {
	...
	PolicyItems *[]BackupScheduleBackupScheduleSpecV20250312EntryPoliciesPolicyItems `json:"policyItems,omitempty"`
}

type BackupScheduleBackupScheduleSpecV20250312EntryPoliciesPolicyItems struct {
	/*
	   FrequencyInterval Number that indicates the frequency interval for a set of Snapshots. A value of `1` specifies the first instance of the corresponding `frequencyType`.
